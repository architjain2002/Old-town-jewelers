...
function Footer({ socket }) {
  ...
  return (
    <div className="footer">
      {chatBot && (
        <ChatBot closeProduct={() => setChatBot(!chatBot)} socket={socket} />
      )}
      <table className="footerTable">
        ...
        <tbody>
          <tr>
            ...
            <td rowSpan="5">
              <i
                className="fa-3x fa-solid fa-comment-dots"
                width="100px"
                height="100px"
          ...
          <tr>
            ...
            <td>
              <a
                href="mailto:gaurangrastogi209@gmail.com"
          ...
          <tr>
            ...
            <td>
              <a
                href="https://github.com/gaurangrastogi"
                target="_blank"
